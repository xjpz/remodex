# Cleanup Plan: `CodexMobile/CodexMobile/Models/GitActionModels.swift`
> ID: CLN-020 | Priority: P1 | Effort: M | Status: planned | File type: source
> Domain: Models | Current LOC: 586
...
- Metrics: 586 LOC, 5 methods/body entries, 117 stored/computed properties estimate, CC estimate 387, max indentation 4.
