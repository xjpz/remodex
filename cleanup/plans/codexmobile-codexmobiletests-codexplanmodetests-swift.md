# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexPlanModeTests.swift`
> ID: CLN-183 | Priority: P0 | Effort: L | Status: planned | File type: test
> Domain: Tests | Current LOC: 1579
...
- Metrics: 1579 LOC, 55 methods/body entries, 157 stored/computed properties estimate, CC estimate 336, max indentation 10.
