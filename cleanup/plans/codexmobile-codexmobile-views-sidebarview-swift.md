# Cleanup Plan: `CodexMobile/CodexMobile/Views/SidebarView.swift`
> ID: CLN-108 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Sidebar UI | Current LOC: 534
...
- Metrics: 534 LOC, 21 methods/body entries, 37 stored/computed properties estimate, CC estimate 115, max indentation 7.
