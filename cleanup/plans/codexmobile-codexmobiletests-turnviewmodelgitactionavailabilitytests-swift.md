# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnViewModelGitActionAvailabilityTests.swift`
> ID: CLN-227 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 94
...
- Metrics: 94 LOC, 7 methods/body entries, 8 stored/computed properties estimate, CC estimate 8, max indentation 4.
