# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Support/TerminalRunningIndicator.swift`
> ID: CLN-130 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 92
> Last updated: 2026-05-11 20:25

## Why This File Is Tracked
- Included in the full Swift/Xcode cleanup scope requested by the user.
- Metrics: 92 LOC, 2 methods/body entries, 4 stored/computed properties estimate, CC estimate 1, max indentation 8.
...
## Progress Notes
- 2026-05-11 20:25: Updated stale ShimmerMask cross-reference after removing unused component from TurnMessageComponents.
