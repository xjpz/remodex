# Cleanup Plan: `CodexMobile/CodexMobileTests/ContentViewModelReconnectTests.swift`
> ID: CLN-203 | Priority: P2 | Effort: S | Status: planned | File type: test
> Domain: Tests | Current LOC: 445
...
- Metrics: 445 LOC, 19 methods/body entries, 70 stored/computed properties estimate, CC estimate 54, max indentation 5.
- Responsibilities: domain/value modeling, test coverage.
