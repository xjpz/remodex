# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnMessageCachesTests.swift`
> ID: CLN-222 | Priority: P2 | Effort: S | Status: planned | File type: test
> Domain: Tests | Current LOC: 417
...
- Metrics: 417 LOC, 27 methods/body entries, 58 stored/computed properties estimate, CC estimate 76, max indentation 4.
