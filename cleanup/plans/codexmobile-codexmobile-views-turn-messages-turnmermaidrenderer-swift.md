# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/TurnMermaidRenderer.swift`
> ID: CLN-153 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 836
...
- Metrics: 836 LOC, 40 methods/body entries, 82 stored/computed properties estimate, CC estimate 166, max indentation 6.
