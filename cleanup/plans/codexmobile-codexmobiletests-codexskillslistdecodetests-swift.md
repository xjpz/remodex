# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexSkillsListDecodeTests.swift`
> ID: CLN-194 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 140
...
- Metrics: 140 LOC, 6 methods/body entries, 19 stored/computed properties estimate, CC estimate 38, max indentation 7.
