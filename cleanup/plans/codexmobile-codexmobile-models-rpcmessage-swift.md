# Cleanup Plan: `CodexMobile/CodexMobile/Models/RPCMessage.swift`
> ID: CLN-023 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 70
...
- Metrics: 70 LOC, 0 methods/body entries, 12 stored/computed properties estimate, CC estimate 23, max indentation 2.
