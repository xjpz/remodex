# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarThreadRunBadgeView.swift`
> ID: CLN-107 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 26
...
- Metrics: 26 LOC, 1 methods/body entries, 3 stored/computed properties estimate, CC estimate 5, max indentation 5.
