# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexGPTAccountTests.swift`
> ID: CLN-181 | Priority: P1 | Effort: M | Status: planned | File type: test
> Domain: Tests | Current LOC: 776
...
- Metrics: 776 LOC, 33 methods/body entries, 63 stored/computed properties estimate, CC estimate 79, max indentation 6.
