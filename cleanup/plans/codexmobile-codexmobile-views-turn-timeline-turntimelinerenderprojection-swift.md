# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Timeline/TurnTimelineRenderProjection.swift`
> ID: CLN-163 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 550
...
- Metrics: 550 LOC, 27 methods/body entries, 81 stored/computed properties estimate, CC estimate 137, max indentation 5.
