# Cleanup Plan: `CodexMobile/CodexMobile/Views/Onboarding/OnboardingView.swift`
> ID: CLN-081 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 173
...
- Metrics: 173 LOC, 4 methods/body entries, 9 stored/computed properties estimate, CC estimate 13, max indentation 6.
