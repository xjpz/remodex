# Cleanup Plan: `CodexMobile/CodexMobile/Views/Home/HomeEmptyStateView.swift`
> ID: CLN-075 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 167
...
- Metrics: 167 LOC, 1 methods/body entries, 15 stored/computed properties estimate, CC estimate 40, max indentation 8.
