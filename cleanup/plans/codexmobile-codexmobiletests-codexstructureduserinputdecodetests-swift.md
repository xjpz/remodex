# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexStructuredUserInputDecodeTests.swift`
> ID: CLN-196 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 224
...
- Metrics: 224 LOC, 10 methods/body entries, 33 stored/computed properties estimate, CC estimate 41, max indentation 5.
