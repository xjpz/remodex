# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnSlashCommandTokenTests.swift`
> ID: CLN-225 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 66
...
- Metrics: 66 LOC, 7 methods/body entries, 3 stored/computed properties estimate, CC estimate 9, max indentation 4.
