# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexService+ProjectFolders.swift`
> ID: CLN-041 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Services | Current LOC: 95
...
- Metrics: 95 LOC, 6 methods/body entries, 21 stored/computed properties estimate, CC estimate 36, max indentation 4.
