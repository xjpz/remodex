# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexSecureTransportModels.swift`
> ID: CLN-028 | Priority: P2 | Effort: S | Status: planned | File type: source
> Domain: Services | Current LOC: 320
...
- Metrics: 320 LOC, 9 methods/body entries, 116 stored/computed properties estimate, CC estimate 71, max indentation 3.
- Responsibilities: service orchestration, domain/value modeling.
