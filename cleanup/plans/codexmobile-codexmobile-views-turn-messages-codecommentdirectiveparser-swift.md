# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/CodeCommentDirectiveParser.swift`
> ID: CLN-112 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 131
...
- Metrics: 131 LOC, 6 methods/body entries, 44 stored/computed properties estimate, CC estimate 41, max indentation 4.
