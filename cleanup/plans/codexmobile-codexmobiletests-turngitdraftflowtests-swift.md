# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnGitDraftFlowTests.swift`
> ID: CLN-220 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 254
...
- Metrics: 254 LOC, 9 methods/body entries, 18 stored/computed properties estimate, CC estimate 50, max indentation 7.
