# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexThreadStartProjectBindingTests.swift`
> ID: CLN-201 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 137
...
- Metrics: 137 LOC, 17 methods/body entries, 23 stored/computed properties estimate, CC estimate 20, max indentation 4.
