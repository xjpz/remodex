# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexModelOption.swift`
> ID: CLN-012 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 182
...
- Metrics: 182 LOC, 7 methods/body entries, 38 stored/computed properties estimate, CC estimate 80, max indentation 4.
