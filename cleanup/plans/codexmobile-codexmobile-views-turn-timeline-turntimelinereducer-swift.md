# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Timeline/TurnTimelineReducer.swift`
> ID: CLN-162 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 838
...
- Metrics: 838 LOC, 43 methods/body entries, 129 stored/computed properties estimate, CC estimate 279, max indentation 6.
