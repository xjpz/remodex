# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/UserBubbleTextBlock.swift`
> ID: CLN-254 | Priority: P3 | Effort: S | Status: done | File type: frontend
...
## Progress Notes
- 2026-05-11 21:05: Extracted user bubble collapse state; newline scan short-circuits.
