# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarThreadListView.swift`
> ID: CLN-105 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Sidebar UI | Current LOC: 491
...
- Metrics: 685 LOC, 28 methods/body entries, 65 stored/computed properties estimate, CC estimate 133, max indentation 8.
- Responsibilities: SwiftUI rendering, sidebar navigation.
...
## Progress Notes
- 2026-05-11 20:38: Extracted project show-more button into its own view with per-button animation state; SidebarThreadListView is now below 500 LOC.
- 2026-05-11 20:34: Extracted project preview, subagent hierarchy, and project expansion pure state into `SidebarThreadListState.swift`.
