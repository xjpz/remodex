# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Core/TurnViewModel+GitBranchWorktree.swift`
> ID: CLN-169 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 817
...
- Metrics: 817 LOC, 30 methods/body entries, 68 stored/computed properties estimate, CC estimate 218, max indentation 7.
- Responsibilities: SwiftUI rendering, domain/value modeling, turn timeline/composer flow.
