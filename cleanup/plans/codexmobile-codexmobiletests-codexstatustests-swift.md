# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexStatusTests.swift`
> ID: CLN-195 | Priority: P2 | Effort: S | Status: planned | File type: test
> Domain: Tests | Current LOC: 321
...
- Metrics: 321 LOC, 15 methods/body entries, 20 stored/computed properties estimate, CC estimate 45, max indentation 8.
