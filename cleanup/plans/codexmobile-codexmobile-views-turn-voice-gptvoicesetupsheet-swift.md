# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Voice/GPTVoiceSetupSheet.swift`
> ID: CLN-122 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 73
...
- Metrics: 73 LOC, 2 methods/body entries, 1 stored/computed properties estimate, CC estimate 3, max indentation 8.
