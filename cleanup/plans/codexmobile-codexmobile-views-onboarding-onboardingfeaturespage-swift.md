# Cleanup Plan: `CodexMobile/CodexMobile/Views/Onboarding/OnboardingFeaturesPage.swift`
> ID: CLN-079 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 85
...
- Metrics: 85 LOC, 2 methods/body entries, 1 stored/computed properties estimate, CC estimate 3, max indentation 6.
