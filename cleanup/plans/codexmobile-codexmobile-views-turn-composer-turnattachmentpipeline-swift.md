# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnAttachmentPipeline.swift`
> ID: CLN-132 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 85
...
- Metrics: 85 LOC, 4 methods/body entries, 19 stored/computed properties estimate, CC estimate 19, max indentation 4.
