# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/CopyBlockButton.swift`
> ID: CLN-119 | Priority: P3 | Effort: S | Status: done | File type: frontend
...
- Metrics: 92 LOC, 1 methods/body entries, 5 stored/computed properties estimate, CC estimate 6, max indentation 7.
