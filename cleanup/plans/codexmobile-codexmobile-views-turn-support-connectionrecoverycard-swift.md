# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Support/ConnectionRecoveryCard.swift`
> ID: CLN-117 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 140
...
- Metrics: 140 LOC, 1 methods/body entries, 15 stored/computed properties estimate, CC estimate 31, max indentation 5.
