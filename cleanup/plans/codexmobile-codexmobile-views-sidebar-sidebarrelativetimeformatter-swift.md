# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarRelativeTimeFormatter.swift`
> ID: CLN-102 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 37
...
- Metrics: 37 LOC, 2 methods/body entries, 7 stored/computed properties estimate, CC estimate 13, max indentation 3.
