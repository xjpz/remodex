# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarFloatingSettingsButton.swift`
> ID: CLN-097 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 42
...
- Metrics: 42 LOC, 2 methods/body entries, 8 stored/computed properties estimate, CC estimate 4, max indentation 4.
