# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexServiceTier.swift`
> ID: CLN-015 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 22
...
- Metrics: 22 LOC, 0 methods/body entries, 3 stored/computed properties estimate, CC estimate 8, max indentation 3.
