# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/FileMentionChip.swift`
> ID: CLN-121 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 275
...
- Metrics: 275 LOC, 13 methods/body entries, 49 stored/computed properties estimate, CC estimate 49, max indentation 7.
