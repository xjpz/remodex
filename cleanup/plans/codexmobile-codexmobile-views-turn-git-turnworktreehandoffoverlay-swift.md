# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Git/TurnWorktreeHandoffOverlay.swift`
> ID: CLN-171 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 179
...
- Metrics: 179 LOC, 1 methods/body entries, 15 stored/computed properties estimate, CC estimate 26, max indentation 7.
