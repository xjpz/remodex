# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Plan/TurnPlanModeComponents.swift`
> ID: CLN-158 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 857
...
- Metrics: 857 LOC, 33 methods/body entries, 122 stored/computed properties estimate, CC estimate 208, max indentation 8.
