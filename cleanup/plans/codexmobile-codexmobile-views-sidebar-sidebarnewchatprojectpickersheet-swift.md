# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarNewChatProjectPickerSheet.swift`
> ID: CLN-101 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 201
...
- Metrics: 201 LOC, 2 methods/body entries, 6 stored/computed properties estimate, CC estimate 9, max indentation 13.
