# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerRuntimeActions.swift`
> ID: CLN-137 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 15
...
- Metrics: 15 LOC, 1 methods/body entries, 4 stored/computed properties estimate, CC estimate 2, max indentation 3.
