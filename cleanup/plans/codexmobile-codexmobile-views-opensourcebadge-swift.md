# Cleanup Plan: `CodexMobile/CodexMobile/Views/OpenSourceBadge.swift`
> ID: CLN-083 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 63
...
- Metrics: 63 LOC, 1 methods/body entries, 6 stored/computed properties estimate, CC estimate 12, max indentation 5.
