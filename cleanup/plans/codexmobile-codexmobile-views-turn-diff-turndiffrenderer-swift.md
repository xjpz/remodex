# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Diff/TurnDiffRenderer.swift`
> ID: CLN-145 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 206
...
- Metrics: 206 LOC, 6 methods/body entries, 23 stored/computed properties estimate, CC estimate 71, max indentation 8.
