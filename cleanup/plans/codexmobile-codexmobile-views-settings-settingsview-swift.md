# Cleanup Plan: `CodexMobile/CodexMobile/Views/Settings/SettingsView.swift`
> ID: CLN-089 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: SwiftUI | Current LOC: 479
...
- Metrics: 1117 LOC, 26 methods/body entries, 66 stored/computed properties estimate, CC estimate 146, max indentation 9.
...
## Progress Notes
- 2026-05-11 20:38: Extracted shared settings primitives and subscription card; SettingsView is now below the 500 LOC cleanup threshold.
- 2026-05-11 20:36: Extracted runtime defaults and connection settings cards into focused component files.
- 2026-05-11 20:34: Extracted About/support and trusted-computer settings components into `SettingsSupportCards.swift`.
