# Cleanup Plan: `CodexMobile/CodexMobile/Models/JSONValue.swift`
> ID: CLN-021 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 96
...
- Metrics: 96 LOC, 1 methods/body entries, 8 stored/computed properties estimate, CC estimate 48, max indentation 3.
