# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexService+History.swift`
> ID: CLN-033 | Priority: P0 | Effort: L | Status: planned | File type: source
> Domain: Services | Current LOC: 2272
...
- Metrics: 2272 LOC, 88 methods/body entries, 278 stored/computed properties estimate, CC estimate 800, max indentation 7.
