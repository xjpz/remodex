# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexServiceTierTests.swift`
> ID: CLN-193 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 186
...
- Metrics: 186 LOC, 9 methods/body entries, 15 stored/computed properties estimate, CC estimate 31, max indentation 5.
