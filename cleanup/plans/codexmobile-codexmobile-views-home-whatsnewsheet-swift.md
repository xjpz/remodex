# Cleanup Plan: `CodexMobile/CodexMobile/Views/Home/WhatsNewSheet.swift`
> ID: CLN-077 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 99
...
- Metrics: 99 LOC, 1 methods/body entries, 8 stored/computed properties estimate, CC estimate 3, max indentation 6.
