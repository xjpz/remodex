# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnGitBranchSelectorTests.swift`
> ID: CLN-219 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 51
...
- Metrics: 51 LOC, 6 methods/body entries, 0 stored/computed properties estimate, CC estimate 6, max indentation 4.
