# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnConnectionRecoverySnapshotBuilderTests.swift`
> ID: CLN-216 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 68
...
- Metrics: 68 LOC, 4 methods/body entries, 4 stored/computed properties estimate, CC estimate 16, max indentation 3.
- Responsibilities: test coverage, turn timeline/composer flow.
