# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarHeaderView.swift`
> ID: CLN-098 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 34
...
- Metrics: 34 LOC, 1 methods/body entries, 3 stored/computed properties estimate, CC estimate 2, max indentation 6.
