# Cleanup Plan: `CodexMobile/CodexMobile/Views/Shared/CodexWorktreeIcon.swift`
> ID: CLN-091 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 74
...
- Metrics: 74 LOC, 4 methods/body entries, 16 stored/computed properties estimate, CC estimate 14, max indentation 4.
