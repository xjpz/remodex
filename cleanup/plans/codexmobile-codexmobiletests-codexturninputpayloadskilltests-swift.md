# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexTurnInputPayloadSkillTests.swift`
> ID: CLN-202 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 221
...
- Metrics: 221 LOC, 12 methods/body entries, 29 stored/computed properties estimate, CC estimate 50, max indentation 9.
