# Cleanup Plan: `CodexMobile/CodexMobile/Views/Onboarding/OnboardingStepPage.swift`
> ID: CLN-080 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 122
...
- Metrics: 122 LOC, 1 methods/body entries, 8 stored/computed properties estimate, CC estimate 7, max indentation 9.
