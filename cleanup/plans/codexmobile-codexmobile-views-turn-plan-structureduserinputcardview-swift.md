# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Plan/StructuredUserInputCardView.swift`
> ID: CLN-128 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 601
...
- Metrics: 601 LOC, 10 methods/body entries, 48 stored/computed properties estimate, CC estimate 96, max indentation 7.
