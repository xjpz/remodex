# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerRuntimeMenuBuilder.swift`
> ID: CLN-138 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 69
...
- Metrics: 69 LOC, 3 methods/body entries, 5 stored/computed properties estimate, CC estimate 14, max indentation 5.
