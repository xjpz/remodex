# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexReasoningEffortOption.swift`
> ID: CLN-014 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 38
...
- Metrics: 38 LOC, 1 methods/body entries, 10 stored/computed properties estimate, CC estimate 18, max indentation 3.
- Responsibilities: domain/value modeling.
