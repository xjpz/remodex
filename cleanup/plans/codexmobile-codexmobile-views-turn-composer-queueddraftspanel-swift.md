# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/QueuedDraftsPanel.swift`
> ID: CLN-124 | Priority: P3 | Effort: S | Status: done | File type: frontend
...
- Metrics: 138 LOC, 1 methods/body entries, 8 stored/computed properties estimate, CC estimate 6, max indentation 10.
