# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarThreadRowView.swift`
> ID: CLN-106 | Priority: P2 | Effort: S | Status: planned | File type: frontend
> Domain: Sidebar UI | Current LOC: 347
...
- Metrics: 347 LOC, 6 methods/body entries, 34 stored/computed properties estimate, CC estimate 51, max indentation 10.
