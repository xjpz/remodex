# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerMetaMapper.swift`
> ID: CLN-136 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 112
...
- Metrics: 112 LOC, 5 methods/body entries, 12 stored/computed properties estimate, CC estimate 46, max indentation 5.
