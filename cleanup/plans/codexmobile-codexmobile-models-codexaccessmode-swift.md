# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexAccessMode.swift`
> ID: CLN-006 | Priority: P3 | Effort: S | Status: done | File type: source
...
- Metrics: 37 LOC, 0 methods/body entries, 4 stored/computed properties estimate, CC estimate 15, max indentation 3.
