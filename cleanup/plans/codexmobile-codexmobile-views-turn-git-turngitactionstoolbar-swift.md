# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Git/TurnGitActionsToolbar.swift`
> ID: CLN-149 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 163
...
- Metrics: 163 LOC, 6 methods/body entries, 19 stored/computed properties estimate, CC estimate 52, max indentation 9.
