# Cleanup Plan: `CodexMobile/CodexMobileTests/CodeCommentDirectiveParserTests.swift`
> ID: CLN-176 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 37
...
- Metrics: 37 LOC, 3 methods/body entries, 6 stored/computed properties estimate, CC estimate 10, max indentation 2.
