# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/ComposerAttachmentsPreview.swift`
> ID: CLN-115 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 17
...
- Metrics: 17 LOC, 1 methods/body entries, 3 stored/computed properties estimate, CC estimate 1, max indentation 5.
