# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarNewChatButton.swift`
> ID: CLN-100 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 60
...
- Metrics: 60 LOC, 1 methods/body entries, 5 stored/computed properties estimate, CC estimate 6, max indentation 7.
