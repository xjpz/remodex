# Cleanup Plan: `CodexMobile/CodexMobile/Views/Shared/AdaptiveGlassModifier.swift`
> ID: CLN-090 | Priority: P3 | Effort: S | Status: done | File type: frontend
...
- Metrics: 62 LOC, 7 methods/body entries, 4 stored/computed properties estimate, CC estimate 13, max indentation 4.
