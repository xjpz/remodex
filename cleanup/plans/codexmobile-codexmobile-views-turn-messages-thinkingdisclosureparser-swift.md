# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/ThinkingDisclosureParser.swift`
> ID: CLN-131 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 173
...
- Metrics: 173 LOC, 7 methods/body entries, 27 stored/computed properties estimate, CC estimate 33, max indentation 5.
