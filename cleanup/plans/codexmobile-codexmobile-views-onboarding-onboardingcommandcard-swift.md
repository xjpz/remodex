# Cleanup Plan: `CodexMobile/CodexMobile/Views/Onboarding/OnboardingCommandCard.swift`
> ID: CLN-078 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 71
...
- Metrics: 71 LOC, 1 methods/body entries, 2 stored/computed properties estimate, CC estimate 3, max indentation 7.
