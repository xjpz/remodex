# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Timeline/TurnScrollStateTracker.swift`
> ID: CLN-159 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 89
...
- Metrics: 89 LOC, 9 methods/body entries, 0 stored/computed properties estimate, CC estimate 30, max indentation 3.
