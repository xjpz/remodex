# Cleanup Plan: `CodexMobile/CodexMobileTests/AIChangeSetTests.swift`
> ID: CLN-174 | Priority: P1 | Effort: M | Status: planned | File type: test
> Domain: Tests | Current LOC: 517
...
- Metrics: 517 LOC, 17 methods/body entries, 72 stored/computed properties estimate, CC estimate 42, max indentation 4.
