# Cleanup Plan: `CodexMobile/CodexMobileTests/SidebarRunBadgePerformanceTests.swift`
> ID: CLN-206 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 81
...
- Metrics: 81 LOC, 4 methods/body entries, 12 stored/computed properties estimate, CC estimate 16, max indentation 5.
