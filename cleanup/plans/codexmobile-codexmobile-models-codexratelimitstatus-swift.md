# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexRateLimitStatus.swift`
> ID: CLN-013 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 117
...
- Metrics: 117 LOC, 4 methods/body entries, 25 stored/computed properties estimate, CC estimate 52, max indentation 5.
