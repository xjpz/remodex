# Cleanup Plan: `CodexMobile/CodexMobile/ContentView.swift`
> ID: CLN-003 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: App | Current LOC: 1259
...
- Metrics: 1259 LOC, 53 methods/body entries, 69 stored/computed properties estimate, CC estimate 307, max indentation 7.
