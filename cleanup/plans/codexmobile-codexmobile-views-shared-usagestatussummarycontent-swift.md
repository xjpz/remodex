# Cleanup Plan: `CodexMobile/CodexMobile/Views/Shared/UsageStatusSummaryContent.swift`
> ID: CLN-095 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 226
...
- Metrics: 226 LOC, 10 methods/body entries, 26 stored/computed properties estimate, CC estimate 62, max indentation 7.
