# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexThread.swift`
> ID: CLN-017 | Priority: P1 | Effort: M | Status: planned | File type: source
> Domain: Models | Current LOC: 524
...
- Metrics: 524 LOC, 20 methods/body entries, 76 stored/computed properties estimate, CC estimate 232, max indentation 5.
