# Cleanup Plan: `CodexMobile/CodexMobile/Models/PetCompanionModels.swift`
> ID: CLN-022 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 147
...
- Metrics: 147 LOC, 3 methods/body entries, 25 stored/computed properties estimate, CC estimate 48, max indentation 3.
