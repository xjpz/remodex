# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/TurnMessageRegexCache.swift`
> ID: CLN-157 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 138
...
- Metrics: 138 LOC, 12 methods/body entries, 14 stored/computed properties estimate, CC estimate 70, max indentation 4.
