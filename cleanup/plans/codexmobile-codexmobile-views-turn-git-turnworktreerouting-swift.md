# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Git/TurnWorktreeRouting.swift`
> ID: CLN-172 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 29
...
- Metrics: 29 LOC, 3 methods/body entries, 1 stored/computed properties estimate, CC estimate 12, max indentation 4.
