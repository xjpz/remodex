# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerSecondaryBar.swift`
> ID: CLN-140 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 174
...
- Metrics: 174 LOC, 2 methods/body entries, 38 stored/computed properties estimate, CC estimate 15, max indentation 7.
