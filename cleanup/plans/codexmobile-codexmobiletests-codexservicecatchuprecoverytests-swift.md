# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexServiceCatchupRecoveryTests.swift`
> ID: CLN-186 | Priority: P2 | Effort: S | Status: planned | File type: test
> Domain: Tests | Current LOC: 314
...
- Metrics: 314 LOC, 8 methods/body entries, 37 stored/computed properties estimate, CC estimate 56, max indentation 9.
