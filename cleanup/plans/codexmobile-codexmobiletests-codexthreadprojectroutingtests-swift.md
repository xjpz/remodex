# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexThreadProjectRoutingTests.swift`
> ID: CLN-198 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 158
...
- Metrics: 158 LOC, 5 methods/body entries, 14 stored/computed properties estimate, CC estimate 39, max indentation 6.
