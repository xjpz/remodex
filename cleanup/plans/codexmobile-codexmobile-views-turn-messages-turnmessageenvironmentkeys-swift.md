# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/TurnMessageEnvironmentKeys.swift`
> ID: CLN-156 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 55
...
- Metrics: 55 LOC, 0 methods/body entries, 6 stored/computed properties estimate, CC estimate 13, max indentation 2.
