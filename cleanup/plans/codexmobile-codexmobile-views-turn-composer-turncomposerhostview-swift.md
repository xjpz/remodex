# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerHostView.swift`
> ID: CLN-134 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 256
...
- Metrics: 256 LOC, 1 methods/body entries, 38 stored/computed properties estimate, CC estimate 27, max indentation 6.
