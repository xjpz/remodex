# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/ComposerAttachmentTile.swift`
> ID: CLN-114 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 68
...
- Metrics: 68 LOC, 2 methods/body entries, 4 stored/computed properties estimate, CC estimate 10, max indentation 8.
