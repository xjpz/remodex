# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarThreadGrouping.swift`
> ID: CLN-104 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 209
...
- Metrics: 209 LOC, 11 methods/body entries, 28 stored/computed properties estimate, CC estimate 69, max indentation 5.
