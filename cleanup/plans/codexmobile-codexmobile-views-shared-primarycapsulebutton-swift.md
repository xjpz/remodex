# Cleanup Plan: `CodexMobile/CodexMobile/Views/Shared/PrimaryCapsuleButton.swift`
> ID: CLN-092 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 33
...
- Metrics: 33 LOC, 1 methods/body entries, 4 stored/computed properties estimate, CC estimate 3, max indentation 6.
