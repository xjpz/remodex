# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexSkillMetadata.swift`
> ID: CLN-016 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 125
...
- Metrics: 125 LOC, 2 methods/body entries, 39 stored/computed properties estimate, CC estimate 37, max indentation 3.
