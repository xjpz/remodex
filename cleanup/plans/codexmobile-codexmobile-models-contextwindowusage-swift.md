# Cleanup Plan: `CodexMobile/CodexMobile/Models/ContextWindowUsage.swift`
> ID: CLN-019 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 37
...
- Metrics: 37 LOC, 1 methods/body entries, 10 stored/computed properties estimate, CC estimate 5, max indentation 4.
