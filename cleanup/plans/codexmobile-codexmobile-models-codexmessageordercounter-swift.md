# Cleanup Plan: `CodexMobile/CodexMobile/Models/CodexMessageOrderCounter.swift`
> ID: CLN-011 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Models | Current LOC: 21
...
- Metrics: 21 LOC, 2 methods/body entries, 2 stored/computed properties estimate, CC estimate 5, max indentation 3.
