# Cleanup Plan: `CodexMobile/RemodexMenuBar/BridgeControlModels.swift`
> ID: CLN-233 | Priority: P3 | Effort: S | Status: done | File type: source
> Domain: Menu bar | Current LOC: 203
...
- Metrics: 203 LOC, 2 methods/body entries, 57 stored/computed properties estimate, CC estimate 80, max indentation 4.
