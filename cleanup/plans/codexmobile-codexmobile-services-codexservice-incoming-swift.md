# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexService+Incoming.swift`
> ID: CLN-034 | Priority: P0 | Effort: L | Status: planned | File type: source
> Domain: Services | Current LOC: 2815
...
- Metrics: 2815 LOC, 104 methods/body entries, 284 stored/computed properties estimate, CC estimate 1404, max indentation 7.
