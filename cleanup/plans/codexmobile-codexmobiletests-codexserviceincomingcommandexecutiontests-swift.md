# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexServiceIncomingCommandExecutionTests.swift`
> ID: CLN-189 | Priority: P0 | Effort: L | Status: planned | File type: test
> Domain: Tests | Current LOC: 1995
...
- Metrics: 1995 LOC, 55 methods/body entries, 339 stored/computed properties estimate, CC estimate 153, max indentation 10.
