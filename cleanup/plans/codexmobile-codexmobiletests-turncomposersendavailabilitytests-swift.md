# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnComposerSendAvailabilityTests.swift`
> ID: CLN-215 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 253
...
- Metrics: 253 LOC, 20 methods/body entries, 35 stored/computed properties estimate, CC estimate 43, max indentation 4.
