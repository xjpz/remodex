# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexServiceConnectionErrorTests.swift`
> ID: CLN-187 | Priority: P2 | Effort: S | Status: planned | File type: test
> Domain: Tests | Current LOC: 247
...
- Metrics: 247 LOC, 25 methods/body entries, 51 stored/computed properties estimate, CC estimate 42, max indentation 4.
