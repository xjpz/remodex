# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/CameraImagePicker.swift`
> ID: CLN-111 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 51
...
- Metrics: 51 LOC, 6 methods/body entries, 11 stored/computed properties estimate, CC estimate 10, max indentation 5.
