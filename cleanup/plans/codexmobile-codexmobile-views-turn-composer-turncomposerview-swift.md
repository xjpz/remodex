# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerView.swift`
> ID: CLN-141 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 733
...
- Metrics: 733 LOC, 7 methods/body entries, 115 stored/computed properties estimate, CC estimate 26, max indentation 9.
