# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/TurnComposerViewState.swift`
> ID: CLN-142 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 63
...
- Metrics: 63 LOC, 0 methods/body entries, 42 stored/computed properties estimate, CC estimate 12, max indentation 2.
