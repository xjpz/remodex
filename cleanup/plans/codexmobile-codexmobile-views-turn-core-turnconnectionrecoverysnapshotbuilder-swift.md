# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Core/TurnConnectionRecoverySnapshotBuilder.swift`
> ID: CLN-143 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 53
...
- Metrics: 53 LOC, 1 methods/body entries, 1 stored/computed properties estimate, CC estimate 22, max indentation 5.
