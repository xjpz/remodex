# Cleanup Plan: `CodexMobile/RemodexMenuBar/RemodexMenuBarApp.swift`
> ID: CLN-237 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Menu bar | Current LOC: 17
...
- Metrics: 17 LOC, 1 methods/body entries, 1 stored/computed properties estimate, CC estimate 2, max indentation 4.
