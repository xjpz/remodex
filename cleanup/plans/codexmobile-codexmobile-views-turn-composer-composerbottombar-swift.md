# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/ComposerBottomBar.swift`
> ID: CLN-116 | Priority: P1 | Effort: M | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 506
...
- Metrics: 506 LOC, 10 methods/body entries, 72 stored/computed properties estimate, CC estimate 66, max indentation 9.
