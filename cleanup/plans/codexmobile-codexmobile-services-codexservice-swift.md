# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexService.swift`
> ID: CLN-060 | Priority: P1 | Effort: M | Status: planned | File type: source
> Domain: Services | Current LOC: 844
...
- Metrics: 844 LOC, 7 methods/body entries, 273 stored/computed properties estimate, CC estimate 219, max indentation 5.
- Responsibilities: service orchestration.

## Current Assessment
- This file exceeds cleanup thresholds or sits near a performance-sensitive path.
- Coupling/import count estimate: 5.
