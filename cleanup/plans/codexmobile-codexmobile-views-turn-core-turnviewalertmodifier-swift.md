# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Core/TurnViewAlertModifier.swift`
> ID: CLN-167 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 148
...
- Metrics: 148 LOC, 4 methods/body entries, 9 stored/computed properties estimate, CC estimate 33, max indentation 7.
