# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Support/TurnImagePreview.swift`
> ID: CLN-151 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 188
...
- Metrics: 188 LOC, 10 methods/body entries, 15 stored/computed properties estimate, CC estimate 28, max indentation 7.
