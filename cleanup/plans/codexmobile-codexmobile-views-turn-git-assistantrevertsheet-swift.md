# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Git/AssistantRevertSheet.swift`
> ID: CLN-109 | Priority: P3 | Effort: S | Status: done | File type: frontend
...
- Metrics: 213 LOC, 5 methods/body entries, 20 stored/computed properties estimate, CC estimate 29, max indentation 7.
