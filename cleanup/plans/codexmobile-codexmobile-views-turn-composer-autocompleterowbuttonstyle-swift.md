# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Composer/AutocompleteRowButtonStyle.swift`
> ID: CLN-110 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 11
...
- Metrics: 11 LOC, 1 methods/body entries, 0 stored/computed properties estimate, CC estimate 2, max indentation 5.
