# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Core/TurnViewLifecycleModifier.swift`
> ID: CLN-168 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 83
...
- Metrics: 83 LOC, 2 methods/body entries, 15 stored/computed properties estimate, CC estimate 8, max indentation 4.
