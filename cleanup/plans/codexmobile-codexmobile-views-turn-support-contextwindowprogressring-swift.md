# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Support/ContextWindowProgressRing.swift`
> ID: CLN-118 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 90
...
- Metrics: 90 LOC, 3 methods/body entries, 13 stored/computed properties estimate, CC estimate 21, max indentation 5.
