# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexService+ThreadsTurns.swift`
> ID: CLN-052 | Priority: P0 | Effort: L | Status: planned | File type: source
> Domain: Services | Current LOC: 2314
...
- Metrics: 2314 LOC, 107 methods/body entries, 212 stored/computed properties estimate, CC estimate 825, max indentation 8.
