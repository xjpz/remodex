# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Support/TurnErrorReportCard.swift`
> ID: CLN-147 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 56
...
- Metrics: 56 LOC, 1 methods/body entries, 6 stored/computed properties estimate, CC estimate 1, max indentation 4.
