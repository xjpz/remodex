# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/ArchivedChatsView.swift`
> ID: CLN-096 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Sidebar UI | Current LOC: 103
...
- Metrics: 103 LOC, 2 methods/body entries, 4 stored/computed properties estimate, CC estimate 20, max indentation 6.
