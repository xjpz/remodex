# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Support/TurnStatusSheet.swift`
> ID: CLN-161 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 31
...
- Metrics: 31 LOC, 1 methods/body entries, 6 stored/computed properties estimate, CC estimate 3, max indentation 4.
