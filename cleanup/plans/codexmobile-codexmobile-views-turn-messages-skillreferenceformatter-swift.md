# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/SkillReferenceFormatter.swift`
> ID: CLN-126 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 196
...
- Metrics: 196 LOC, 13 methods/body entries, 26 stored/computed properties estimate, CC estimate 54, max indentation 4.
