# Cleanup Plan: `CodexMobile/CodexMobileTests/CodexFuzzyFileSearchDecodeTests.swift`
> ID: CLN-180 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 44
...
- Metrics: 44 LOC, 3 methods/body entries, 8 stored/computed properties estimate, CC estimate 16, max indentation 5.
