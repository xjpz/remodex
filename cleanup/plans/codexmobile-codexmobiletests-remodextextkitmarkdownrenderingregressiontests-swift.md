...
- Metrics: 31 LOC, 2 methods/body entries, 3 stored/computed properties estimate, CC estimate 2, max indentation 4.
- Responsibilities: SwiftUI rendering, test coverage.
