# Cleanup Plan: `CodexMobile/CodexMobile/Services/CodexService+Messages.swift`
> ID: CLN-038 | Priority: P0 | Effort: L | Status: planned | File type: source
> Domain: Services | Current LOC: 4449
...
- Metrics: 4449 LOC, 167 methods/body entries, 439 stored/computed properties estimate, CC estimate 1497, max indentation 9.
