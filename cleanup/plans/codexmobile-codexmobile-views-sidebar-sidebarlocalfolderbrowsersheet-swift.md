# Cleanup Plan: `CodexMobile/CodexMobile/Views/Sidebar/SidebarLocalFolderBrowserSheet.swift`
> ID: CLN-099 | Priority: P2 | Effort: S | Status: planned | File type: frontend
> Domain: Sidebar UI | Current LOC: 352
...
- Metrics: 352 LOC, 16 methods/body entries, 36 stored/computed properties estimate, CC estimate 60, max indentation 7.
