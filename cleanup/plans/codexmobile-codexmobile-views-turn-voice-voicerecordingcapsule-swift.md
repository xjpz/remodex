# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Voice/VoiceRecordingCapsule.swift`
> ID: CLN-173 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 213
...
- Metrics: 213 LOC, 6 methods/body entries, 35 stored/computed properties estimate, CC estimate 24, max indentation 8.
