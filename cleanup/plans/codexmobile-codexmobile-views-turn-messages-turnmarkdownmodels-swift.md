# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Messages/TurnMarkdownModels.swift`
> ID: CLN-152 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: Turn UI | Current LOC: 19
...
- Metrics: 19 LOC, 0 methods/body entries, 1 stored/computed properties estimate, CC estimate 8, max indentation 3.
