# Cleanup Plan: `CodexMobile/CodexMobileTests/AssistantTurnEndActionVisibilityTests.swift`
> ID: CLN-175 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 87
...
- Metrics: 87 LOC, 4 methods/body entries, 4 stored/computed properties estimate, CC estimate 4, max indentation 5.
