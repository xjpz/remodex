# Cleanup Plan: `CodexMobile/CodexMobile/Views/Turn/Core/TurnViewModel.swift`
> ID: CLN-170 | Priority: P0 | Effort: L | Status: planned | File type: frontend
> Domain: Turn UI | Current LOC: 2405
...
- Metrics: 2405 LOC, 134 methods/body entries, 323 stored/computed properties estimate, CC estimate 693, max indentation 8.
