# Cleanup Plan: `CodexMobile/CodexMobileTests/SkillReferenceFormatterTests.swift`
> ID: CLN-209 | Priority: P3 | Effort: S | Status: done | File type: test
> Domain: Tests | Current LOC: 36
...
- Metrics: 36 LOC, 4 methods/body entries, 8 stored/computed properties estimate, CC estimate 4, max indentation 3.
