# Cleanup Plan: `CodexMobile/CodexMobile/Views/Shared/TrustedPairSummaryView.swift`
> ID: CLN-094 | Priority: P3 | Effort: S | Status: done | File type: frontend
> Domain: SwiftUI | Current LOC: 67
...
- Metrics: 67 LOC, 1 methods/body entries, 5 stored/computed properties estimate, CC estimate 7, max indentation 7.
