# Cleanup Plan: `CodexMobile/RemodexMenuBar/BridgeMenuBarStore.swift`
> ID: CLN-235 | Priority: P2 | Effort: S | Status: planned | File type: source
> Domain: Menu bar | Current LOC: 268
...
- Metrics: 268 LOC, 21 methods/body entries, 17 stored/computed properties estimate, CC estimate 80, max indentation 7.
- Responsibilities: menu bar.
