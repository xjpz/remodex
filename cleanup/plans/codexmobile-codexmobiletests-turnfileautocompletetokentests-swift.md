# Cleanup Plan: `CodexMobile/CodexMobileTests/TurnFileAutocompleteTokenTests.swift`
> ID: CLN-217 | Priority: P2 | Effort: S | Status: planned | File type: test
> Domain: Tests | Current LOC: 172
...
- Metrics: 172 LOC, 25 methods/body entries, 20 stored/computed properties estimate, CC estimate 33, max indentation 4.
